...
$ar_label = '';
if(!empty($atts['radio_label'])):
  $ar_label = $atts['radio_label'];
endif;
$ar_style = 'abstyle1';
if(!empty($atts['radio_style'])):
  $ar_style = $atts['radio_style'];
endif;
$ar_download = '';
$ar_type = '';
if(!empty($atts['radio_type'])):
  $ar_type = $atts['radio_type'];
endif;
$radio_par_slide = '';
if(!empty($atts['radio_par_slide'])):
  $radio_par_slide = $atts['radio_par_slide'];
endif;
$ar_number = 12;
if(!empty($atts['radio_number'])):
  $ar_number = $atts['radio_number'];
endif;
$musictype = 'radio';
$list_type = 'music';
...
if( is_user_logged_in() && $lang_data ){
    ...
    $ar_args = array('post_type' => 'ms-radios',
...
$radio_posts = new WP_Query( $ar_args );

if( $radio_posts->have_posts() ): 
  $slidermeta = array('per_view' => $radio_par_slide);
    if( $ar_style == 'abstyle1' ): ?>
        <div class="ms_fea_album_slider ms-slider">
            <div class="ms_heading">
                <h1><?php echo esc_html( $ar_label ); ?></h1>
            </div>
            <div class="ms_relative_inner">
               <div class="ms_slider<?php esc_attr_e($ar_style); ?> swiper-container swiper-container-horizontal" data-blogmeta="<?php echo esc_attr(json_encode($slidermeta))?>" data-type="<?php esc_attr_e($ar_style); ?>">
                                    ...
                                    <div class="ms_rcnt_box_img">
                                        ...
                                        <div class="ms_main_overlay">
                                            ...
                                            <ul class="more_option">
                                                <li>
                                                    <a href="javascript:;" class="favourite_radios" data-radioid="<?php echo esc_attr(get_the_id()); ?>">
                                                    <span class="opt_icon">
                        ...
                        <div class="col-lg-2 col-md-6 col-sm-6 col-12">
                            <div class="ms_rcnt_box marger_bottom30">
                                <div class="ms_rcnt_box_img">
                                    ...
                                    <div class="ms_main_overlay">
                                        <div class="ms_box_overlay"></div>
                                        <?php if(!empty($moreimage)): ?>
                                            <div class="ms_more_icon">
                                                <img src="<?php echo esc_url($moreimage); ?>" alt="<?php  esc_attr_e('more image','miraculous'); ?>">
                                            </div>
                                        <?php endif; 
                                            $fav_class = 'icon_fav';
                                            if(function_exists('miraculous_get_favourite_div_class')){
                                        ...
                                        <ul class="more_option">
                                            ...
                                            <li>
                                               <a href="javascript:;"><span class="opt_icon"><span class="icon icon_dwn">
                                ...
                                <div class="ms_rcnt_box_text">
                                    ...
                                    <?php $artists_name = array(); $artists_ids = fw_get_db_post_option(get_the_id(), 'radio_artists'); 
                                    foreach ($artists_ids as $artists_id) {
                                         $artists_name[] = get_the_title($artists_id);
                                     } ?>
                                    <p><?php echo implode(',', $artists_name); ?></p>
    ...
    if( $ar_style == 'abstyle3' ): ?>
        <div class="ms_weekly_wrapper">
                    <div class="ms_weekly_inner">
                        ...
                        <?php $i=1; $n = $radio_posts->found_posts; $rm = $n%3;
                        ...
                        <div class="col-lg-4 col-md-6">
                                    <div class="ms_weekly_box">
                                        ...
                                        <div class="weekly_right">
                                            ...
                                            <?php if(function_exists('miraculous_total_radio_length')){
                                                echo miraculous_total_radio_length(get_the_id());
                                            } ?></span>
                                            <?php if(!empty($more_icon)): ?>
                    ...
                    <?php while ( $radio_posts->have_posts() ) : $radio_posts->the_post(); ?>
                        <div class="swiper-slide">
                            <div class="ms_release_box">
                                ...
                                <div class="weekly_right">
                                    <span class="w_song_time"><?php if(function_exists('miraculous_total_radio_length')){
                                        echo miraculous_total_radio_length(get_the_id());
                                    } ?></span>
                                </div>
                            </div>
                    ...
                    <div class="ms_artist_slider ms-slider">
                        <div class="slider_heading_wrap">
                            ...
                            <div class="slider_cmn_controls">
                                <div class="slider_cmn_nav"><span class="swiper-button-prev-<?php esc_attr_e($ar_style); ?> slider_nav_prev"></span></div>
                                <div class="slider_cmn_nav"><span class="swiper-button-next-<?php esc_attr_e($ar_style); ?> slider_nav_next"></span></div>
                            </div>
                        </div> 
                                            ...
                                            <div class="slider_cbox slider_artist_box text-center">
                                                <div class="slider_cimgbox slider_artist_imgbox">
                                                    <?php 
                                                        ...
                                                        $genre_thumbnail_img = wp_get_attachment_image_src( $image_id, 'thumbnail' );
                                                    ?>
                                                    <img src="<?php echo $genre_thumbnail_img[0]; ?>" alt="<?php $genre->name; ?>" />
                                                </div> 
                                                <div class="slider_ctext slider_artist_text">
                                                    <a class="slider_ctitle slider_artist_ttl" href="<?php 
                                                        $term_link = get_term_link( $genre );
                                                        echo esc_url( $term_link ); ?>">
                                                         <?php echo $genre->name;?>
                                                    </a> 
                                                    <p class="slider_cdescription slider_artist_des">Total Channel : <?php echo $genre->count; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                   <?php }
                                    ...
                                    ?> 
                                        <div class="swiper-slide">
                                            <div class="slider_cbox slider_artist_box text-center">
                                                <div class="slider_cimgbox slider_artist_imgbox">
                                                    <?php 
                                                        $image_id = get_term_meta( $location->term_id, 'miraculous-taxonomy-image-id', true );
                                                        $genre_thumbnail_img = wp_get_attachment_image_src( $image_id, 'thumbnail' );
                                                    ?>
                                                    <img src="<?php echo $genre_thumbnail_img[0]; ?>" alt="<?php $location->name; ?>" />
                                                </div> 
                                                <div class="slider_ctext slider_artist_text">
                                                    <a class="slider_ctitle slider_artist_ttl" href="<?php 
                                                    ...
                                                    <p class="slider_cdescription slider_artist_des">Total Channel : <?php echo $location->count; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                   <?php }
