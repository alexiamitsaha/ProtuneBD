...
$dowenload_heading = $mpurl = '';
if(!empty($atts['dowenload_heading'])):
    $dowenload_heading = $atts['dowenload_heading'];
endif;

$dowenload_style;
if(!empty($atts['dowenload_style'])):
    $dowenload_style = $atts['dowenload_style'];
endif;
            ...
            <div class="album_inner_list">
                <div class="slider_heading_wrap marger_bottom30">
                    <div class="slider_cheading">
                        <h4 class="cheading_title"><?php echo esc_html($dowenload_heading); ?></h4>
                    </div> 
                </div>
...
<?php } else{?>
    <div class="ms_free_download ms_purchase_wrapper">
        <div class="ms_heading"> 
            <h1><?php echo esc_html($dowenload_heading); ?></h1> 
        </div>
        <div class="album_inner_list">
            <div class="album_list_wrapper">
                <ul class="album_list_name">
