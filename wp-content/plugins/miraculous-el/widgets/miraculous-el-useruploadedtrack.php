 ...
 * @since 1.0.0
 */
class Miraculous_useruploadedtrack extends Widget_Base {
	...
	public function get_title() {
		return __( 'User Uploaded Track', 'miraculous' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
            'heading',
            [
                'label' => esc_html__( 'User Uploaded Track', 'miraculous' ),
            ]
        );
        $this->add_control(
            'useruploadedtrack_heading',
            [
	...
	protected function render() {
        ...
        $sg_label = '';
        if(!empty($settings['useruploadedtrack_heading'])):
            $sg_label = $settings['useruploadedtrack_heading'];
        endif;
        $sg_number = -1;
