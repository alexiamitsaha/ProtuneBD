 ...
 * @since 1.0.0
 */
class Miraculous_freetrackupload extends Widget_Base {
	...
	public function get_title() {
		return __( 'Free Track Upload', 'miraculous' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
            'heading',
            [
                'label' => esc_html__( 'Free Track Upload', 'miraculous' ),
            ]
        );
        $this->add_control(
            'freetrackupload_heading_one',
            [
            ...
            <div class="ms_upload_wrapper">
                ...
                <form id="upload_music_form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ms_upload_box">
                        <h2><?php echo esc_html($settings['freetrackupload_heading_two']); ?></h2>
                    ...
                    <div class="marger_top60">
                        <div class="ms_upload_box">
                            <div class="ms_heading">
                                <h1><?php echo esc_html($settings['freetrackupload_heading_three']); ?></h1>
                            </div>
                            <div class="ms_pro_form">
                                ...
                                <div class="form-group">
                                    <label><?php echo esc_html('Select Privacy', 'miraculous'); ?></label>
                                    <select name="privacy_name" id="up_privacy_name" class="form-control">
                                        <option value="publish"><?php echo esc_html__('Public', 'miraculous'); ?></option>
                                        <option value="private"><?php echo esc_html__('Private', 'miraculous'); ?></option>
                                    </select>
                                </div>
                                <div class="form-group">
                ...
                <?php else: ?>
                    <form id="artist_create_form" method="post" action="<?php echo esc_url(get_the_permalink().'?do=upload_music'); ?>">
                        <div class="marger_top60">
                            <div class="ms_upload_box">
                                <div class="ms_heading">
                                    <h1><?php echo esc_html($settings['freetrackupload_heading_one']); ?></h1>
                                </div>
                                <div class="ms_pro_form">
