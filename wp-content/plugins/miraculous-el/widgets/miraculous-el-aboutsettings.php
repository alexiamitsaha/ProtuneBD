 ...
 * @since 1.0.0
 */
class Miraculous_aboutsettings extends Widget_Base {
	...
	public function get_title() {
		return __( 'About Settings', 'miraculous' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
            'heading',
            [
                'label' => esc_html__( 'About Settings', 'miraculous' ),
            ]
        );
        $this->add_control(
            'aboutsettings_heading',
            [
                'label'       => esc_html__( 'About Settings Heading', 'miraculous' ),
	...
	protected function render() {
        ...
        $profile_heading = '';
        if(!empty($settings['aboutsettings_heading'])):
          $profile_heading = $settings['aboutsettings_heading'];
        endif;
