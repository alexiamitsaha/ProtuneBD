 ...
 * @since 1.0.0
 */
class Miraculous_pricingplan extends Widget_Base {
	...
	public function get_title() {
		return __( 'Pricing Plan', 'miraculous' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
            'heading',
            [
                'label' => esc_html__( 'Pricing Plan', 'miraculous' ),
            ]
        );
        $this->add_control(
            'pricingplan_heading',
            [
                'label'       => esc_html__( 'Pricing Plan Heading', 'miraculous' ),
		...
		$this->add_control(
			'pricingplan',
			[
				'label' => __( 'Pricing Plan', 'miraculous' ),
                'label_block' => ('bool'),
	...
	protected function render() {
        ...
        if(!empty($settings['pricingplan'])){
          $ms_args = array(
            			 'post_type' => 'ms-plans',
                         'post__in'=> $settings['pricingplan']
                         ); 
        }
        else{
        ...
        <div class="ms_account_wrapper">
            <div class="container">
                <div class="row justify-content-center">
                    <?php if(!empty($settings['pricingplan_heading'])): ?>
                        <div class="col-lg-12">
                            <div class="ms_heading">
                                <h1><?php echo __($settings['pricingplan_heading']); ?></h1>
                            </div>
                        </div>
                    <?php endif; ?>
