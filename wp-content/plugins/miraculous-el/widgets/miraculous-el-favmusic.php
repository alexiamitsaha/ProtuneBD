 ...
 * @since 1.0.0
 */
class Miraculous_favmusic extends Widget_Base {
	...
	public function get_title() {
		return __( 'Favourites Music', 'miraculous' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
            'heading',
            [
                'label' => esc_html__( 'Favourites Music', 'miraculous' ),
            ]
        );
        $this->add_control(
            'favmusic_heading',
            [
                'label'       => esc_html__( 'Favourites Music Heading', 'miraculous' ),
        ...
        $this->add_control(
			'list_by',
			[
				'label' => esc_html__( 'List by', 'miraculous' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'songs',
				'options' => [
					'songs'  => esc_html__( 'Songs', 'miraculous' ),
					'albums' => esc_html__( 'Albums', 'miraculous' ),
					'artist' => esc_html__( 'Artists', 'miraculous' ),
					'radio' => esc_html__( 'Radios', 'miraculous' ),
				],
			]
		);
		$this->add_control(
        ...
        $this->add_control(
            'song_number',
            [
                'label'       => esc_html__( 'Number of songs', 'miraculous' ),
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'default'     => esc_html__( '', 'miraculous' ),
            ]
	...
	protected function render() {
        ...
        $fav_style_type = $settings['style_format'];
        ...
        $fav_style = $settings['list_by'];
        if($userid): 
            if($fav_style == 'songs'):
            if($music_ids):
                $sg_args = array('post_type' => 'ms-music',
                                'posts_per_page' => $settings['song_number'],
                                'post__in' => $music_ids,
                                );
                ...
                $list_type = 'music';
        			...
        			<?php if(!empty($settings['favmusic_heading'])): ?>
                        <div class="ms_heading">
                            <h1><?php echo esc_html($settings['favmusic_heading']); ?></h1>
                        </div>
        			<?php endif; ?>
