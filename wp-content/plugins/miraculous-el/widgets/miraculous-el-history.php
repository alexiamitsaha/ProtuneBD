 ...
 * @since 1.0.0
 */
class Miraculous_history extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
            'history',
            [
                'label' => esc_html__( 'History', 'miraculous' ),
            ]
        );
        $this->add_control(
            'history_heading',
            [
                'label'       => esc_html__( 'History Heading', 'miraculous' ),
	...
	protected function render() {
        ...
        if($music_ids && $userid):
        	...
        	$sg_args = array('post_type' => 'ms-music',
        	                'posts_per_page' => $settings['history_number'],
        	                'orderby' => 'date',
                    		'order'   => 'DESC',
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="ms_heading">
                            <h1><?php echo esc_html( $settings['history_heading'] ); ?></h1>
                        </div>
                    </div>
