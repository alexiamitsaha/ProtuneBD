 ...
 * @since 1.0.0
 */
class Miraculous_userproduct extends Widget_Base {
	...
	public function get_title() {
		return __( 'User Product', 'miraculous' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
            'heading',
            [
                'label' => esc_html__( 'User Product', 'miraculous' ),
            ]
        );
        $this->add_control(
            'userproduct_heading',
	...
	protected function render() {
        ...
        $usv_label = '';
        if(!empty($settings['userproduct_heading'])):
          $usv_label = $settings['userproduct_heading'];
        endif;
