 ...
 * @since 1.0.0
 */
class Miraculous_musictab extends Widget_Base {
	...
	public function get_title() {
		return __( 'Music Tab', 'miraculous' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
            'heading',
            [
                'label' => esc_html__( 'Music Tab', 'miraculous' ),
            ]
        );
        $this->add_control(
            'musictab_heading',
            [
                'label'       => esc_html__( 'Music Tab Heading', 'miraculous' ),
	...
	protected function render() {
        ...
        $sg_number = 12;
        if(!empty($settings['musictab_number'])):
            $sg_number = $settings['musictab_number'];
        endif;
        ...
        <div class="ms_songslist_main">
            <?php
                if(!empty($settings['musictab_heading'])){
                ?>
                    <div class="ms_heading">
                        <h1><?php echo esc_html( $settings['musictab_heading'] ); ?></h1>
                    </div>  
                <?php 
                }
            ?>
                                    ...
                                    <div class="ms_songslist_inner">
                                        <div class="ms_songslist_left">
                                            <div class="songslist_number play_btn play_music" data-musicid="<?php esc_html_e(get_the_id()); ?>" data-musictype="<?php printf($list_type); ?>">
                                                ...
                                                <span class="songslist_play"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/svg/play.svg" alt="Play" class="img-fluid"/></span>
                                            </div> 
