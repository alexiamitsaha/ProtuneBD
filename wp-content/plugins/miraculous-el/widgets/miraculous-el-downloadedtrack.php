 ...
 * @since 1.0.0
 */
class Miraculous_downloadedtrack extends Widget_Base {
	...
	public function get_title() {
		return __( 'Downloaded Tracks', 'miraculous' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
            'heading',
            [
                'label' => esc_html__( 'Downloaded Tracks', 'miraculous' ),
            ]
        );
        $this->add_control(
            'downloaded_heading',
                ...
                <div class="ms_download_inner">
                    <div class="album_inner_list">
                        <div class="slider_heading_wrap marger_bottom30">
                            <?php if(!empty($settings['downloaded_heading'])){ ?>
                            <div class="slider_cheading">
                                <h4 class="cheading_title"><?php echo esc_html($settings['downloaded_heading']); ?></h4>
                            </div> 
                            <?php } ?>
                        </div>
                    <div class="album_list_wrapper">
                        ...
                        <ul class="ms_list_songs donload-song-<?php echo esc_attr($dowenload_style); ?>">
                            <li>
                                <a href="javascript:;" class="dwld_sn">
                                    <span class="play_no"><?php echo (strlen($i) < 2) ? '0'.$i : $i; ?></span>
                                    <span class="play_hover equlizer">
                                        <svg class="lds-equalizer" width="40px"  height="40px"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid"><g transform="rotate(180 50 50)"><rect ng-attr-x="{{7.6923076923076925 - config.width/2}}" y="36" ng-attr-width="{{config.width}}" height="24.0108" x="4.6923076923076925" width="3">
                                            ...
                                            </animate></rect><rect ng-attr-x="{{15.384615384615385 - config.width/2}}" y="36" ng-attr-width="{{config.width}}" height="28.4181" x="12.384615384615385" width="3">
                                            ...
                                            </animate></rect><rect ng-attr-x="{{23.076923076923077 - config.width/2}}" y="36" ng-attr-width="{{config.width}}" height="8.11305" x="20.076923076923077" width="3">
                                            ...
                                            </animate></rect><rect ng-attr-x="{{30.76923076923077 - config.width/2}}" y="36" ng-attr-width="{{config.width}}" height="29.9656" x="27.76923076923077" width="3">
                                            ...
                                            </animate></rect><rect ng-attr-x="{{38.46153846153846 - config.width/2}}" y="36" ng-attr-width="{{config.width}}" height="4.08943" x="35.46153846153846" width="3">
                                            ...
                                            </animate></rect><rect ng-attr-x="{{46.15384615384615 - config.width/2}}" y="36" ng-attr-width="{{config.width}}" height="10.4173" x="43.15384615384615" width="3">
                           ...
                           <?php $music_extranal_url = get_post_meta(get_the_id(), 'fw_option:music_extranal_url', true);
                            ...
                            <li class="text-center">
                                <a href="javascript:;" class="remove_free_music" musicid="<?php echo esc_attr(get_the_id()); ?>">
        ...
        <?php } else{?>
            <div class="ms_free_download ms_purchase_wrapper">
                ...
                <div class="ms_heading"> 
                    <h1><?php echo esc_html($settings['downloaded_heading']); ?></h1> 
                </div>
                <?php } ?>
                <div class="album_inner_list">
                    <div class="album_list_wrapper">
                                    ...
                                    <li class="text-center ms_more_icon"><a href="javascript:;"><span class="ms_icon1 ms_active_icon">
                                        ...
                                        <ul class="SDSF more_option">
                                            ...
                                            <li><a href="javascript:;" class="ms_share_music" data-shareuri="<?php esc_attr_e(get_the_permalink()); ?>" data-sharename="<?php the_title_attribute(); ?>"><span class="opt_icon"><span class="icon icon_share">
        										<svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 22 22"><title>icon</title><g id="_14-2" data-name=" 14-2"><path id="_13" data-name=" 13" class="cls-1" d="M8.68,13.18A2.78,2.78,0,0,1,4.77,13l-.07-.08a3,3,0,0,1,0-3.85,2.77,2.77,0,0,1,3.89-.36.52.52,0,0,1,.11.1l3-2.11.09-.06a1.09,1.09,0,0,0,.63-1.08A2.76,2.76,0,0,1,15.05,3,2.84,2.84,0,0,1,17.9,5.22a3,3,0,0,1-1.36,3.22,2.72,2.72,0,0,1-3.34-.5l-.27-.3C11.81,8.41,10.7,9.18,9.6,10a.37.37,0,0,0-.09.28q0,.75,0,1.5a.51.51,0,0,0,.13.34c1.08.77,2.18,1.52,3.3,2.3a2.89,2.89,0,0,1,1.76-1.15A2.83,2.83,0,0,1,18,15.56h0A2.92,2.92,0,0,1,15.72,19a2.82,2.82,0,0,1-3.28-2.28,3.33,3.33,0,0,1,0-.63.55.55,0,0,0-.16-.38ZM6.82,9.55a1.45,1.45,0,0,0,0,2.9,1.45,1.45,0,0,0,0-2.9ZM15.2,7.36a1.43,1.43,0,0,0,1.39-1.45h0A1.4,1.4,0,1,0,15.2,7.36Zm0,7.29a1.42,1.42,0,0,0-1.4,1.43h0a1.4,1.4,0,0,0,1.44,1.36,1.4,1.4,0,0,0,0-2.8Z"/></g></svg>
