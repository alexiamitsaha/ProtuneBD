 ...
 * @since 1.0.0
 */
class Miraculous_playlist extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
            'heading',
            [
                'label' => esc_html__( 'Playlist', 'miraculous' ),
            ]
        );
        $this->add_control(
            'playlist_heading',
            [
                'label'       => esc_html__( 'Playlist Heading', 'miraculous' ),
	...
	protected function render() {
        ...
        <div class="ms_top_artist">
            <div class="container-fluid">
                <div class="row">
                    <?php if(!empty($settings['playlist_heading'])): ?>
                        <div class="col-lg-12">
                            <div class="ms_heading">
                                <h1><?php echo esc_html($settings['playlist_heading']); ?></h1>
                            </div>
                        </div>
                    <?php endif; 
                    if(!empty($user_id)): ?>
