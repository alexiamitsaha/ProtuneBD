 ...
 * @since 1.0.0
 */
class Miraculous_artist extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
            'heading',
            [
                'label' => esc_html__( 'Artist', 'miraculous' ),
            ]
        );
        $this->add_control(
            'artist_heading',
            [
                'label'       => esc_html__( 'Artist Heading', 'miraculous' ),
        ...
        $this->add_control(
			...
			[
				...
				'default' => 'abstyle1',
				'options' => [
					'arstyle1' => esc_html__( 'Slider', 'miraculous' ),
					'arstyle2' => esc_html__( 'Grid', 'miraculous' ),
					'arstyle3' => esc_html__( 'Slider 2', 'miraculous' ),
				],
			]
		);
		$this->add_control(
			...
			[
                ...
                'multiple' => true,
                'options' => get_custom_type_category('artist-type')
			]
		);
        $this->add_control(
            'artist_number',
            [
                'label'       => esc_html__( 'Number of Artist', 'miraculous' ),
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'default'     => esc_html__( '', 'miraculous' ),
            ]
        ...
        $this->add_control(
            'artist_slide',
            [
                'label'       => esc_html__( 'Artist Per Slide', 'miraculous' ),
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'default'     => esc_html__( '', 'miraculous' ),
            ]
	...
	protected function render() {
        ...
        if(empty($settings['artist_type'])){
            $test = get_terms('artist-type');
            $tests =  $test[0];
            $settings['artist_type'] = $tests->term_id;
        }
        $fav_album_ids = ''; 
        if($user_id){
        ...
        if( is_user_logged_in() && $lang_data ){
            $ar_args = array(
                ...
                'posts_per_page' => $settings['artist_number'],
                'tax_query' => array(
                        array(
                            'taxonomy' => 'artist-type',
                            'terms' => $settings['artist_type']
                        ),
                        array(
                            'taxonomy' => 'language',
                            'terms' => $lang_data
        ...
        $ar_type = $settings['artist_type'][0];
        $slidermeta = array('per_view' => $settings['artist_slide']);
        if( $artist_posts->have_posts() ): 
            if( $settings['style_format'] == 'arstyle1' ){
            ?>
            <div class="ms_featured_slider ms-slider">
               <?php if(!empty($settings['artist_heading'])): ?>
                <div class="ms_heading">
                    <h1><?php echo esc_html($settings['artist_heading']); ?></h1>
                    <span class="veiw_all">
            		</span>
                </div>
            	<?php endif; ?>
            ...
            <?php } elseif( $settings['style_format'] == 'arstyle2' ){ ?>
                                ...
                                <div class="slider_heading_wrap">
                                    <?php if(!empty($settings['artist_heading'])): ?>
                                        <div class="slider_cheading">
                                            <h4 class="cheading_title"><?php echo esc_html($settings['artist_heading']); ?></h4>
                                        </div>
            	                    <?php endif; ?>
                                    <!-- Add Arrows -->
                                    <div class="slider_cmn_controls">
                                        <div class="slider_cmn_nav">
                                            <div class="swiper-button-prev-<?php echo $ar_type; ?> swiper-button-prev-elementor mira-ver3" tabindex="0" role="button" aria-label="Previous slide" aria-disabled="false">
                                            	<svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="512" height="512" x="0" y="0" viewBox="0 0 128 128" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g><path xmlns="http://www.w3.org/2000/svg" id="Down_Arrow_3_" d="m64 88c-1.023 0-2.047-.391-2.828-1.172l-40-40c-1.563-1.563-1.563-4.094 0-5.656s4.094-1.563 5.656 0l37.172 37.172 37.172-37.172c1.563-1.563 4.094-1.563 5.656 0s1.563 4.094 0 5.656l-40 40c-.781.781-1.805 1.172-2.828 1.172z" data-original="#000000" class=""></path></g></svg>
                                            </div>
                                        </div>
                                        <div class="slider_cmn_nav">
                                            <div class="swiper-button-next-<?php echo $ar_type; ?> swiper-button-next-elementor mira-ver3" tabindex="0" role="button" aria-label="Next slide" aria-disabled="false">
                                            	<svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="512" height="512" x="0" y="0" viewBox="0 0 128 128" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g><path xmlns="http://www.w3.org/2000/svg" id="Down_Arrow_3_" d="m64 88c-1.023 0-2.047-.391-2.828-1.172l-40-40c-1.563-1.563-1.563-4.094 0-5.656s4.094-1.563 5.656 0l37.172 37.172 37.172-37.172c1.563-1.563 4.094-1.563 5.656 0s1.563 4.094 0 5.656l-40 40c-.781.781-1.805 1.172-2.828 1.172z" data-original="#000000" class=""></path></g></svg>
                                            </div>
                                        </div>
                                    </div>
